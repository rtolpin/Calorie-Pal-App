    ...
    <Animated.View entering={FadeInDown.delay(index * 60).springify()}>
      ...
      <View style={styles.card}>
        <TouchableOpacity onPress={handlePhotoPress} style={styles.photoContainer} testID="photo-container">
          {log.photo_url ? (
            <Image source={{ uri: log.photo_url }} style={styles.photo} accessibilityLabel={`Photo of ${log.meal_name}`} />
          ) : (
        ...
        <View style={styles.content}>
          {/* Top affordance — makes it clear the entry is tappable */}
          <TouchableOpacity
            onPress={goToEdit}
          ...
          >
            <Ionicons name="pencil-outline" size={11} color={Colors.secondary} />
            <Text style={styles.editEntryHeaderText}>View or Edit this Entry</Text>
            <Ionicons name="chevron-forward-outline" size={11} color={Colors.secondary} />
          </TouchableOpacity>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerActions}>
              {onToggleFavorite && (
                <TouchableOpacity onPress={onToggleFavorite} style={styles.actionBtn} testID="favorite-btn">
                  <Ionicons
